...
1. `Open_Agent_Safety_Kit_Grant_Deck_Elegant.pdf` — primary polished grant deck
2. `Open_Agent_Safety_Kit_Grant_Deck.pdf` — simpler backup deck
3. `Open_Agent_Safety_Kit_One_Pager.pdf` — optional short summary
